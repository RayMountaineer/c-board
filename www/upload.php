...
<head>
<meta charset="UTF-8" /> 
	<title>C-BOARD: Picture-upload -> give trust, earn trust</title>
...
<?php
	...
	echo '<h2 style="font-size: 1.6em; font-weight: 400; text-align: left; ">C-BOARD :: Y O U R - P E R S O N A L I T Y</h2><hr />';
...
echo'<tr style="line-height: 0.7em;"><td><h3 style="font-size: 1.3em; text-align:center; padding: 0.5em;">u p l o a d   _  P I C T U R E   _  d i s t i n g u i s h i n g </3></td></tr></table><br>';
...
?>
 <form enctype="multipart/form-data" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="post" id="nwbs">	
	...
	<fieldset>
		<legend>SELECT & UPLOAD YOUR PICTURE</legend>
...
if(!isset($_FILES['userfile']))
    {
    echo '<p>Please browse, select your picture-file and click the submit-button</p>';
    }
else
    {
    try    {
...
//
$stmt = $pdo->prepare("UPDATE usrsprofiles SET  image=?, image_size=?, image_type=?, avatar=? WHERE username=?");
