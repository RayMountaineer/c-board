...
// form ende 
 ...
 if ( isset( $_GET['usrIDsetAccessOf'] ) && !empty( $_GET['usrIDsetAccessOf'] ) )
 {
 	$selectedUsername = $_GET['usrIDsetAccessOf'];
...
// php-driven html part of the table:
	 		...
	 		$USRid2SETaccess4 =$UsarsID['id']; 	 
	 			...
	 			echo'</tr>'; // wbs lev1 grün m. HAP-name als Überschrift
  			 } 
