...
$insertdb = "INSERT INTO forum_posts (tid,Pid,username,email,topic,text,im,ap,statstat) VALUES (:tid,:Pid, :username, :email, :topic, :text, :im, :ap, :stat)";

$pdoexec = $pdo->prepare($insertdb);
$pdoexec->execute(array(':tid'=>$tid,':Pid'=>$Pid,':username'=>$username,':email'=>$email,':topic'=>$topic, ':text'=>$text, ':im'=>$im, ':ap'=>$ap, ':stat'=>$stat, ));
