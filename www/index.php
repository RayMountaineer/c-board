...
// html part now below - else the headers already sent problem occurs..
...
// redirect to:
			...
			$targetfolder = substr($actual_link, 0, -9); // index.php = 9 chars
...
<meta name="viewport" content="width=device-width, initial-scale=0.7"> 
  ...
  <div id="divform">
    ...
    <form  action="index.php" class="form" id="form1" name="entryForm" method="post" style="margin-top:9em;" >
   ...
   <div class="ENTERbtn">
      ...
      <span>
		...
		<a class="penciltext" href ="./login/register.php"><span>For using this application you need to Register (click!)</span></a>      
		</span>
		 <span>
		<a class="infotext" href ="./login/Apply4newPW.php"><span>Click me, if You forgot username or password for this slot!</span></a>      
		</span>	      
      </p>
    </form>
  </div>
