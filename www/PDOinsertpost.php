...
header('location:threadview.php?ID=' . $_SESSION["strg_id"] . '#box'); //ID-Wert / die variable "$strg_id" muss noch mit irgendeiner Methode übergeben werden. evtl. via SESSION?  
